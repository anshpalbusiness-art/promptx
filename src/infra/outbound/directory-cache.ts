...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: PromptXConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: PromptXConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: PromptXConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: PromptXConfig): void {
