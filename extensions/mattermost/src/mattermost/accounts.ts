...
export function listMattermostAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: PromptXConfig): string {
...
export function listEnabledMattermostAccounts(cfg: PromptXConfig): ResolvedMattermostAccount[] {
