...
export function listIMessageAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: PromptXConfig): string {
...
function mergeIMessageAccountConfig(cfg: PromptXConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: PromptXConfig): ResolvedIMessageAccount[] {
