...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PromptXConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PromptXConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = PromptXConfigFile.loadDict()
            ...
            PromptXConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/promptx"
        state.remoteCliPath = ""
        return state
    }
}
