...
import { type PromptXConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PromptXConfig): string[] {
...
export function listAgentsForGateway(cfg: PromptXConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PromptXConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: PromptXConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: PromptXConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: PromptXConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: PromptXConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: PromptXConfig): GatewaySessionsDefaults {
