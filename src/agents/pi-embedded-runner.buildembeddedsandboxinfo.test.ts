...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies PromptXConfig;

const _ensureModels = (cfg: PromptXConfig, agentDir: string) =>
  ensurePromptXModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/promptx-sandbox",
      agentWorkspaceDir: "/tmp/promptx-workspace",
      ...
      browser: {
        ...
        containerName: "promptx-sbx-browser-test",
      },
