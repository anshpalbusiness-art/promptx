...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "promptx-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolvePromptXPackageRoot } = await import("./promptx-root.js");
    ...
    vi.mocked(resolvePromptXPackageRoot).mockResolvedValue("/opt/promptx");
