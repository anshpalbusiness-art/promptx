...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@promptx", { botUsername: "promptx" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@promptx args", {
        botUsername: "promptx",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "promptx" })).toBe(
      "/help@otherbot",
    );
  });
