---
summary: "Use Qwen OAuth (free tier) in PromptX"
read_when:
  - You want to use Qwen with PromptX
...
If you already logged in with the Qwen Code CLI, PromptX will sync credentials
