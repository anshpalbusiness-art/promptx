...
export const DEFAULT_LOG_DIR = "/tmp/promptx";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "promptx.log"); // legacy single-file path

const LOG_PREFIX = "promptx";
...
function resolveSettings(): ResolvedSettings {
  let cfg: PromptXConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => PromptXConfig;
      };
