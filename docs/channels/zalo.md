...
- Install via CLI: `promptx plugins install @promptx/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `promptx plugins install ./extensions/zalo`
   - From npm (if published): `promptx plugins install @promptx/zalo`
...
- Approve via:
  - `promptx pairing list zalo`
  - `promptx pairing approve zalo <CODE>`
...
- Example: `promptx message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `promptx channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `promptx logs --follow`
