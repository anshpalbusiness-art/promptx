...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PromptXChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PromptXChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
