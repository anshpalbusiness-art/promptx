...
# Output:
# - dist/PromptX.app
# - dist/PromptX-<version>.zip
# - dist/PromptX-<version>.dmg
...
ZIP="$ROOT_DIR/dist/PromptX-$VERSION.zip"
DMG="$ROOT_DIR/dist/PromptX-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/PromptX-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/PromptX-$VERSION.dSYM.zip"
