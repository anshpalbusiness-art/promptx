...
function resolveMainSessionKeyForSandbox(params: { cfg?: PromptXConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: PromptXConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`promptx sandbox explain --session ${runtime.sessionKey}`)}`,
  );
