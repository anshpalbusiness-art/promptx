...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.promptx", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".promptx/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.promptxCommand(
            subcommand: "gateway",
