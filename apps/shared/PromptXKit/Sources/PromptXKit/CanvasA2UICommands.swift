...
public enum PromptXCanvasA2UICommand: String, Codable, Sendable {
...
public struct PromptXCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PromptXCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
