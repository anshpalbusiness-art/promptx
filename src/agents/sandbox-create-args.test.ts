  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "promptx.sandbox=1",
        "--label",
        "promptx.sessionKey=main",
        "--label",
        "promptx.createdAtMs=1700000000000",
        "--label",
        "promptx.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
