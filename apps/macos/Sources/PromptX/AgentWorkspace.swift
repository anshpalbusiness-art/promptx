...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.promptx", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PromptXConfigFile.defaultWorkspaceURL() }
