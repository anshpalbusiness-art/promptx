...
function resolveDefaultAccountId(cfg: PromptXConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PromptXConfig): boolean {
...
export function summarizeBindings(cfg: PromptXConfig, bindings: AgentBinding[]): string[] {
