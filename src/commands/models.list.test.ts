...
const ensurePromptXModelsJson = vi.fn().mockResolvedValue(undefined);
const resolvePromptXAgentDir = vi.fn().mockReturnValue("/tmp/promptx-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/promptx-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensurePromptXModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolvePromptXAgentDir,
}));
