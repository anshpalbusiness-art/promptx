...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: PromptXPhotosLatestParams) async throws -> PromptXPhotosLatestPayload {
        ...
        var results: [PromptXPhotoPayload] = []
        ...
        return PromptXPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> PromptXPhotoPayload
    {
