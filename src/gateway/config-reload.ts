...
import type { PromptXConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: PromptXConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: PromptXConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: PromptXConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: PromptXConfig) => void;
  log: {
