...
Nostr DM channel plugin for PromptX using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to PromptX. It enables your bot to:
...
# Configure promptx to use local relay
