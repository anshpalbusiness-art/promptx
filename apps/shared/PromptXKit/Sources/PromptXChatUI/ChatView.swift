...
@MainActor
public struct PromptXChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: PromptXChatViewModel
    ...
    public init(
        viewModel: PromptXChatViewModel,
    ...
    private var visibleMessages: [PromptXChatMessage] {
        let base: [PromptXChatMessage]
    ...
    private func mergeToolResults(in messages: [PromptXChatMessage]) -> [PromptXChatMessage] {
    ...
    private func isToolResultMessage(_ message: PromptXChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: PromptXChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: PromptXChatMessage) -> String {
