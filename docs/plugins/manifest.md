...
read_when:
  - You are building a PromptX plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (promptx.plugin.json)

Every plugin **must** ship a `promptx.plugin.json` file in the **plugin root**.
PromptX uses this manifest to validate configuration **without executing plugin
