...
// pi-ai's built-in Anthropic catalog can lag behind PromptX's defaults/docs.
...
export function buildModelAliasLines(cfg?: PromptXConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolvePromptXAgentDir();
