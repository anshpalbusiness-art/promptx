...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PromptXConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PromptXConfig; env: NodeJS.ProcessEnv }): {
  cfg: PromptXConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
