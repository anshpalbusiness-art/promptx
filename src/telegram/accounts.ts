...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.PROMPTX_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PromptXConfig): string {
...
function mergeTelegramAccountConfig(cfg: PromptXConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: PromptXConfig): ResolvedTelegramAccount[] {
