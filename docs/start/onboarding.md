---
summary: "First-run onboarding flow for PromptX (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give PromptX">
...
<Step title="CLI">
  ...
  The app can install the global `promptx` CLI via npm/pnpm so terminal
