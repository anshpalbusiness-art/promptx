...
PromptX treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.promptx/settings/voicewake.json`

Shape:

```json
{ "triggers": ["promptx", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
