...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "promptx-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<PromptXConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<PromptXConfig["telegram"]>>,
