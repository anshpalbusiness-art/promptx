...
PromptX has two separate “streaming” layers:
...
When block streaming is enabled, PromptX can **merge consecutive block chunks**
...
When draft streaming is active, PromptX disables block streaming for that reply to avoid double-streaming.
