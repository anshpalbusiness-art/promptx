...
const SANDBOX_EXAMPLES = {
  main: [
    ["promptx sandbox list", "List all sandbox containers."],
    ["promptx sandbox list --browser", "List only browser containers."],
    ["promptx sandbox recreate --all", "Recreate all containers."],
    ["promptx sandbox recreate --session main", "Recreate a specific session."],
    ["promptx sandbox recreate --agent mybot", "Recreate agent containers."],
    ["promptx sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["promptx sandbox list", "List all sandbox containers."],
    ["promptx sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["promptx sandbox recreate --all", "Recreate all containers."],
    ["promptx sandbox recreate --session main", "Recreate a specific session."],
    ["promptx sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["promptx sandbox recreate --browser --all", "Recreate only browser containers."],
    ["promptx sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["promptx sandbox explain", "Show effective sandbox config."],
    ["promptx sandbox explain --session agent:main:main", "Explain a specific session."],
    ["promptx sandbox explain --agent work", "Explain an agent sandbox."],
    ["promptx sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.promptx.ai/cli/sandbox")}\n`,
    )
    .action(() => {
