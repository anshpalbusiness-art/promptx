## PromptX Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_promptx-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm promptx gateway --port 18789 --verbose
```
