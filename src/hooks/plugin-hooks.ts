...
import type { PromptXPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: PromptXPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: PromptXPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
