...
export function listZalouserAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: PromptXConfig): string {
...
function mergeZalouserAccountConfig(cfg: PromptXConfig, accountId: string): ZalouserAccountConfig {
