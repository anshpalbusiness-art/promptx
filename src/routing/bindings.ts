...
export function listBindings(cfg: PromptXConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: PromptXConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PromptXConfig) {
