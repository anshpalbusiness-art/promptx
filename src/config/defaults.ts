...
function resolveAnthropicDefaultAuthMode(cfg: PromptXConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: PromptXConfig): PromptXConfig {
...
export function applyTalkApiKey(config: PromptXConfig): PromptXConfig {
...
export function applyModelDefaults(cfg: PromptXConfig): PromptXConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: PromptXConfig): PromptXConfig {
...
export function applyLoggingDefaults(cfg: PromptXConfig): PromptXConfig {
...
export function applyContextPruningDefaults(cfg: PromptXConfig): PromptXConfig {
...
export function applyCompactionDefaults(cfg: PromptXConfig): PromptXConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
