...
public enum PromptXTalkCommand: String, Codable, Sendable {
...
public struct PromptXTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct PromptXTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
