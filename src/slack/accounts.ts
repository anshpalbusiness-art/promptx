...
export function listSlackAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: PromptXConfig): string {
...
function mergeSlackAccountConfig(cfg: PromptXConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: PromptXConfig): ResolvedSlackAccount[] {
