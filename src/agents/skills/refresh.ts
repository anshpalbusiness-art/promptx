...
function resolveWatchPaths(workspaceDir: string, config?: PromptXConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PromptXConfig }) {
