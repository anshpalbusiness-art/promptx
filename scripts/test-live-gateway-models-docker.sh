...
docker run --rm -t \
  ...
  -e PROMPTX_LIVE_GATEWAY_MODELS="${PROMPTX_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e PROMPTX_LIVE_GATEWAY_PROVIDERS="${PROMPTX_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e PROMPTX_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${PROMPTX_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
