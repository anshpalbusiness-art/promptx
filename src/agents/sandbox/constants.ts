...
export const DEFAULT_SANDBOX_IMAGE = "promptx-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "promptx-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "promptx-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "promptx-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "promptx-sbx-browser-";
