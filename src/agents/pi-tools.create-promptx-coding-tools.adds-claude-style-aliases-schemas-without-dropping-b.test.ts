...
describe("createPromptXCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createPromptXCodingTools({
      config,
    ...
    const anthropicTools = createPromptXCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createPromptXCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createPromptXCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
