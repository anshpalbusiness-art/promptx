import type { PromptXConfig } from "./config.js";
...
function isTelegramConfigured(cfg: PromptXConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: PromptXConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: PromptXConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: PromptXConfig): boolean {
...
function isIMessageConfigured(cfg: PromptXConfig): boolean {
...
function isWhatsAppConfigured(cfg: PromptXConfig): boolean {
...
function isGenericChannelConfigured(cfg: PromptXConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: PromptXConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: PromptXConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: PromptXConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: PromptXConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: PromptXConfig, pluginId: string): PromptXConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
