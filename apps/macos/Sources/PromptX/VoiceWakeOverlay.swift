...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.promptx", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other PromptX windows, but below the system’s pop-up menus.
