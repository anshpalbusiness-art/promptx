...
This directory contains the **BlueBubbles external channel plugin** for PromptX.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `promptx/plugin-sdk` helpers.
