...
function resolveConfiguredModelRaw(cfg: PromptXConfig): string {
...
function resolveConfiguredModelKeys(cfg: PromptXConfig): string[] {
...
export function applyPrimaryModel(cfg: PromptXConfig, model: string): PromptXConfig {
...
export function applyModelAllowlist(cfg: PromptXConfig, models: string[]): PromptXConfig {
  const defaults = cfg.agents?.defaults;
