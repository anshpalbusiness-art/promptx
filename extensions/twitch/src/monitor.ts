...
import type { ReplyPayload, PromptXConfig } from "promptx/plugin-sdk";
import { createReplyPrefixOptions } from "promptx/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as PromptXConfig;
