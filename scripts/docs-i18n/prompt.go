...
- Keep product names in English: PromptX, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the PromptX Gateway, use “Gateway 网关”.
