...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = PromptXLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = PromptXLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.promptx.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(PromptXLocationMode.off.rawValue)
                            Text("While Using").tag(PromptXLocationMode.whileUsing.rawValue)
                            Text("Always").tag(PromptXLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while PromptX is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = PromptXLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: PromptXLocationMode {
        PromptXLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
