...
export function listSignalAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: PromptXConfig): string {
...
function mergeSignalAccountConfig(cfg: PromptXConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: PromptXConfig): ResolvedSignalAccount[] {
