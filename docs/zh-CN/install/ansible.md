...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 PromptX 安装
title: Ansible
x-i18n:
...
将 PromptX 部署到生产服务器的推荐方式是通过 **[promptx-ansible](https://github.com/openclaw/openclaw-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/openclaw/promptx-ansible](https://github.com/openclaw/openclaw-ansible)**
>
> promptx-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/promptx-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 PromptX

Ansible 安装程序设置 PromptX 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [promptx-ansible](https://github.com/openclaw/openclaw-ansible) — 完整部署指南
