...
export type ChannelAgentToolFactory = (params: { cfg?: PromptXConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PromptXConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: PromptXConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PromptXConfig }) => boolean;
  supportsCards?: (params: { cfg: PromptXConfig }) => boolean;
