...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.promptx", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.promptx", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: PromptXProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
