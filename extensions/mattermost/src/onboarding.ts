import type { ChannelOnboardingAdapter, PromptXConfig, WizardPrompter } from "promptx/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.promptx.ai/channels/mattermost",
    ].join("\n"),
