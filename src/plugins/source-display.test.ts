...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/promptx/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/promptx/extensions",
        global: "/Users/x/.promptx/extensions",
        workspace: "/Users/x/ws/.promptx/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.promptx/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/promptx/extensions",
        global: "/Users/x/.promptx/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.promptx/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/promptx/extensions",
        global: "/Users/x/.promptx/extensions",
