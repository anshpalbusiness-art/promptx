...
public typealias PromptXPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PromptXPlatformImage = UIImage
#endif

public struct PromptXChatUsageCost: Codable, Hashable, Sendable {
...
public struct PromptXChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PromptXChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PromptXChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PromptXChatMessageContent: Codable, Hashable, Sendable {
...
public struct PromptXChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PromptXChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PromptXChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PromptXChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PromptXChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PromptXChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PromptXChatMessageContent].self, forKey: .content) {
...
public struct PromptXChatHistoryPayload: Codable, Sendable {
...
public struct PromptXSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PromptXSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PromptXSessionPreviewItem]
}

public struct PromptXSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PromptXSessionPreviewEntry]

    public init(ts: Int, previews: [PromptXSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PromptXChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PromptXChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PromptXAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PromptXChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PromptXGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PromptXPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PromptXPlatformImage?
...
public struct PromptXChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
