...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.promptx", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.promptx", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PromptXChatMessage] = messages.compactMap { item in
