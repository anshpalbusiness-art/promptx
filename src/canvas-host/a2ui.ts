...
export const A2UI_PATH = "/__promptx__/a2ui";

export const CANVAS_HOST_PATH = "/__promptx__/canvas";

export const CANVAS_WS_PATH = "/__promptx__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.promptxCanvasA2UIAction.postMessage(...)
  // - Android: window.promptxCanvasA2UIAction.postMessage(...)
  const handlerNames = ["promptxCanvasA2UIAction"];
  ...
  globalThis.PromptX = globalThis.PromptX ?? {};
  globalThis.PromptX.postMessage = postToNode;
  globalThis.PromptX.sendUserAction = sendUserAction;
  globalThis.promptxPostMessage = postToNode;
  globalThis.promptxSendUserAction = sendUserAction;
