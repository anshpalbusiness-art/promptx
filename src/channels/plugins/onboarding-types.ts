...
export type PromptAccountIdParams = {
  ...
  label: string;
  currentId?: string;
  listAccountIds: (cfg: PromptXConfig) => string[];
...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: PromptXConfig) => DmPolicy;
  setPolicy: (cfg: PromptXConfig, policy: DmPolicy) => PromptXConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: PromptXConfig) => PromptXConfig;
};
