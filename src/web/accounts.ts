...
function listConfiguredAccountIds(cfg: PromptXConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: PromptXConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: PromptXConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: PromptXConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: PromptXConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: PromptXConfig): ResolvedWhatsAppAccount[] {
