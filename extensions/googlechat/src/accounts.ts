...
export function listGoogleChatAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: PromptXConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: PromptXConfig): ResolvedGoogleChatAccount[] {
