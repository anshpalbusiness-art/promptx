...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.promptx", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("PromptX/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__promptx__/a2ui/").absoluteString + "?platform=macos"
    }
