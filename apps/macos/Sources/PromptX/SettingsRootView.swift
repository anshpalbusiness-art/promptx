...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .promptxSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? PromptXPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? PromptXPaths.stateDirURL.path
...
extension Notification.Name {
    static let promptxSelectSettingsTab = Notification.Name("promptxSelectSettingsTab")
}
