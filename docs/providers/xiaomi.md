---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with PromptX"
read_when:
  - You want Xiaomi MiMo models in PromptX
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). PromptX uses
