...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.promptx.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("promptx hooks list")}`,
      `  ${formatCliCommand("promptx hooks enable <name>")}`,
      `  ${formatCliCommand("promptx hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
