      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">promptx dashboard --no-open</span> → open the Control UI<br />
            <span class="mono">promptx doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <input
              ...
              placeholder="PROMPTX_GATEWAY_TOKEN"
            />
          </label>
          <label class="field">
