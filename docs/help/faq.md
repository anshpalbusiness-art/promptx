---
summary: "Frequently asked questions about PromptX setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up PromptX?](#whats-the-recommended-way-to-install-and-set-up-promptx)
  ...
  - [I can't access docs.openclaw.ai (SSL error). What now?](#i-cant-access-docspromptxai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or promptx not recognized](#windows-install-says-git-not-found-or-promptx-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install PromptX on Linux?](#how-do-i-install-promptx-on-linux)
  - [How do I install PromptX on a VPS?](#how-do-i-install-promptx-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask PromptX to update itself?](#can-i-ask-promptx-to-update-itself)
  ...
  - [If I buy a Mac mini to run PromptX, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-promptx-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different PromptX instances?](#can-multiple-people-use-one-whatsapp-number-with-different-promptx-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run PromptX on a dedicated machine?](#how-important-is-it-to-run-promptx-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run PromptX in a VM and what are the requirements](#can-i-run-promptx-in-a-vm-and-what-are-the-requirements)
- [What is PromptX?](#what-is-promptx)
  - [What is PromptX, in one paragraph?](#what-is-promptx-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for PromptX](#what-are-the-top-five-everyday-use-cases-for-promptx)
  - [Can PromptX help with lead gen outreach ads and blogs for a SaaS](#can-promptx-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can PromptX run tasks on a schedule or continuously in the background?](#can-promptx-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with PromptX saved locally?](#is-all-data-used-with-promptx-saved-locally)
  - [Where does PromptX store its data?](#where-does-promptx-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall PromptX?](#how-do-i-completely-uninstall-promptx)
...
- [Config basics](#config-basics)
  ...
  - [Can the PromptX browser run headless?](#can-the-promptx-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two PromptX instances talk to each other (local + VPS)?](#can-two-promptx-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does PromptX load environment variables?](#how-does-promptx-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of PromptX instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-promptx-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset PromptX but keep it installed?](#how-do-i-completely-reset-promptx-but-keep-it-installed)
  ...
  - [Why doesn't PromptX reply in a group?](#why-doesnt-promptx-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do PromptX, Flawd, and Krill use for models?](#what-do-promptx-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `promptx gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-promptx-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `promptx gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-promptx-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run PromptX in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-promptx-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart PromptX?](#i-closed-my-terminal-on-windows-how-do-i-restart-promptx)
  ...
  - [ELI5: `promptx gateway restart` vs `promptx gateway`](#eli5-promptx-gateway-restart-vs-promptx-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose PromptX to inbound DMs?](#is-it-safe-to-expose-promptx-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/promptx/promptx-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   promptx health --json
   promptx health --verbose   # shows the target URL + config path on errors
   ```
...
This installs PromptX **from a git checkout**, so the agent can read the code + docs and
...
```bash
promptx status
promptx models status
promptx doctor
```

What they do:

- `promptx status`: quick snapshot of gateway/agent health + basic config.
- `promptx models status`: checks provider auth + model availability.
- `promptx doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `promptx status --all`, `promptx logs --follow`,
`promptx gateway status`, `promptx health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up PromptX

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://openclaw.ai/install.sh | bash
promptx onboard --install-daemon
```
...
If you don't have a global install yet, run it via `pnpm promptx onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `PROMPTX_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `promptx config get gateway.auth.token` (or generate one: `promptx doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `promptx gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `promptx gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install PromptX on the new machine.
2. Copy `$PROMPTX_STATE_DIR` (default: `~/.promptx`) from the old machine.
3. Copy your workspace (default: `~/.promptx/workspace`).
4. Run `promptx doctor` and restart the Gateway service.
...
under `~/.promptx/` (for example `~/.promptx/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-promptx-store-its-data),
...
detail: [Troubleshooting](/help/troubleshooting#docspromptxai-shows-an-ssl-error-comcastxfinity).
...
### Windows install says git not found or promptx not recognized
...
**2) promptx is not recognized after install**
...
### How do I install PromptX on Linux
...
### How do I install PromptX on a VPS
...
### Can I ask PromptX to update itself
...
```bash
promptx update
promptx update status
promptx update --channel stable|beta|dev
promptx update --tag <dist-tag|version>
promptx update --no-restart
```

If you must automate from an agent:

```bash
promptx update --yes --no-restart
promptx gateway restart
```
...
`promptx onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run PromptX with **API keys** (Anthropic/OpenAI/others) or with
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `promptx models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `promptx models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. PromptX no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so PromptX can keep replying while a provider is rate-limited.
...
PromptX supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. PromptX fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `promptx.json`.

Steps:

1. Enable the plugin: `promptx plugins enable google-gemini-cli-auth`
2. Login: `promptx models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. PromptX needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. PromptX runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run PromptX can I connect it to my MacBook Pro
...
- Use `promptx nodes status` / `promptx nodes list` to see it.
...
- DM your bot, then run `promptx logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different PromptX instances
...
If you run PromptX via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the PromptX code install. Your state
(`~/.promptx`) and workspace (`~/.promptx/workspace`) stay untouched.
...
**PromptX-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run PromptX on a dedicated machine
...
PromptX is lightweight. For a basic Gateway + one chat channel:
...
### Can I run PromptX in a VM and what are the requirements
...
### What is PromptX in one paragraph

PromptX is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

PromptX is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for PromptX
...
### Can PromptX help with lead gen outreach ads and blogs for a SaaS
...
PromptX draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

PromptX is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use PromptX when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.promptx/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.promptx/promptx.json`). Precedence is `<workspace>/skills` > `~/.promptx/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.promptx/promptx.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.promptx/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which PromptX treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `PROMPTX_SKIP_CRON` is not set.
...
```bash
promptx cron run <jobId> --force
promptx cron runs --id <jobId> --limit 50
```
...
### Can PromptX run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.promptx.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-promptx-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. PromptX can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.promptx/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "promptx": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured PromptX workspace); PromptX treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.promptx/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `PROMPTX_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `PROMPTX_DOCKER_APT_PACKAGES`.
...
PromptX memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

PromptX also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, PromptX auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, PromptX
prefers `local`.
...
### Is all data used with PromptX saved locally

No - **PromptX's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.promptx` + your workspace directory).
...
### Where does PromptX store its data

Everything lives under `$PROMPTX_STATE_DIR` (default: `~/.promptx`):

| Path                                                           | Purpose                                                      |
| -------------------------------------------------------------- | ------------------------------------------------------------ |
| `$PROMPTX_STATE_DIR/promptx.json`                              | Main config (JSON5)                                          |
| `$PROMPTX_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$PROMPTX_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$PROMPTX_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$PROMPTX_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$PROMPTX_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$PROMPTX_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$PROMPTX_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.promptx/agent/*` (migrated by `promptx doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.promptx/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.promptx`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.promptx`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.promptx/skills`).

Default workspace is `~/.promptx/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.promptx/workspace" } },
}
```
...
Do **not** commit anything under `~/.promptx` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall PromptX
...
`workspace` to the repo root. The PromptX repo is just source code; keep the
...
PromptX reads an optional **JSON5** config from `$PROMPTX_CONFIG_PATH` (default: `~/.promptx/promptx.json`):

```
$PROMPTX_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.promptx/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `PROMPTX_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `promptx doctor --generate-gateway-token`.
...
key. **Recommended:** run `promptx configure --section web` to store it in
...
- Daemons read env vars from `~/.promptx/.env` (or the service environment).
...
### Can the PromptX browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   promptx nodes pending
   promptx nodes approve <requestId>
   ```
...
- Gateway is running: `promptx gateway status`
- Gateway health: `promptx status`
- Channel health: `promptx channels status`
...
### Can two PromptX instances talk to each other local VPS
...
`promptx agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
promptx agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.promptx/promptx.json`).
- If you have no backup, re-run `promptx doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `promptx config set` for small changes.
- Use `promptx configure` for interactive edits.
...
```bash
promptx gateway --tailscale serve
```
...
### How does PromptX load environment variables

PromptX reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.promptx/.env` (aka `$PROMPTX_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.promptx/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`PROMPTX_LOAD_SHELL_ENV=1`, `PROMPTX_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`promptx models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means PromptX won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.promptx/.env`:
...
### Is there a way to make a team of PromptX instances one CEO and many agents
...
### How do I completely reset PromptX but keep it installed
...
```bash
promptx reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `PROMPTX_PROFILE`), reset each state dir (defaults are `~/.promptx-<profile>`).
- Dev reset: `promptx gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), PromptX skips the heartbeat run to save API calls.
...
No. PromptX runs on **your own account**, so if you're in the group, PromptX can see it.
...
```bash
promptx directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt PromptX reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.promptx/agents/<agentId>/sessions/`.
...
- Use `promptx doctor` to spot stray workspaces and profile mismatches.
...
PromptX's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, PromptX currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `promptx models set ...` (updates just model config)
- `promptx configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.promptx/promptx.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `promptx doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do PromptX, Flawd, and Krill use for models

- **PromptX + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. PromptX ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.promptx/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `promptx agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so PromptX can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.promptx/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.promptx/agent/*` (migrated by `promptx doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.promptx/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `promptx models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `promptx models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `promptx models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.promptx/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    promptx models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), PromptX will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: PromptX now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
PromptX uses provider-prefixed IDs like:
...
PromptX may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `promptx models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
promptx models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
promptx models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
promptx models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
promptx models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

PromptX supports both:
...
```
--port > PROMPTX_GATEWAY_PORT > gateway.port > default 18789
```

### Why does promptx gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `promptx gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does promptx gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `PROMPTX_STATE_DIR` mismatch).
...
PromptX enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `promptx gateway --port <port>`.

### How do I run PromptX in remote mode client connects to a Gateway elsewhere
...
- `promptx gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `promptx.control.settings.v1`.

Fix:

- Fastest: `promptx dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `promptx doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `PROMPTX_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `promptx status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `PROMPTX_CONFIG_PATH` (per-instance config)
- `PROMPTX_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `promptx --profile <name> …` per instance (auto-creates `~/.promptx-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `promptx --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.promptx.*`, `promptx-gateway-<profile>.service`, `PromptX Gateway (<profile>)`).
...
```
promptx tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/promptx/promptx-YYYY-MM-DD.log
```
...
- macOS: `$PROMPTX_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.promptx/logs/...`; profiles use `~/.promptx-<profile>/logs/...`)
- Linux: `journalctl --user -u promptx-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "PromptX Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `promptx gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart PromptX
...
1. Is the Gateway running? `promptx gateway status`
2. Is the Gateway healthy? `promptx status`
3. Does the UI have the right token? `promptx dashboard`
...
```bash
promptx channels status
promptx channels logs --channel telegram
```
...
### ELI5 promptx gateway restart vs promptx gateway

- `promptx gateway restart`: restarts the **background service** (launchd/systemd).
- `promptx gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `promptx gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [PromptX assistant setup](/start/promptx) and [Agent send](/tools/agent-send).

CLI sending:

```bash
promptx message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose PromptX to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `promptx pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `promptx pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `promptx doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. PromptX only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
promptx pairing approve whatsapp <code>
```

List pending requests:

```bash
promptx pairing list whatsapp
```
...
PromptX blocks **cross-provider** messaging by default. If a tool call is bound
