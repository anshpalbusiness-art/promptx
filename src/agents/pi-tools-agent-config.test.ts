...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createPromptXCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createPromptXCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createPromptXCodingTools({
      config: cfg,
    ...
    const defaultTools = createPromptXCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createPromptXCodingTools({
      config: cfg,
    ...
    const bobTools = createPromptXCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createPromptXCodingTools({
      config: cfg,
