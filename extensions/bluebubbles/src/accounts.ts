...
export function listBlueBubblesAccountIds(cfg: PromptXConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: PromptXConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: PromptXConfig): ResolvedBlueBubblesAccount[] {
