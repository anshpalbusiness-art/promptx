...
export function applyZaiConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyOpenrouterProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyOpenrouterConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyMoonshotProviderConfig(cfg: PromptXConfig): PromptXConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: PromptXConfig): PromptXConfig {
...
export function applyMoonshotConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyMoonshotConfigCn(cfg: PromptXConfig): PromptXConfig {
...
export function applyKimiCodeProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applySyntheticProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyXiaomiProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: PromptXConfig): PromptXConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: PromptXConfig): PromptXConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyXaiProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: PromptXConfig): PromptXConfig {
...
export function applyQianfanProviderConfig(cfg: PromptXConfig): PromptXConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: PromptXConfig): PromptXConfig {
