...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @promptx/voice-call -> voice-call).
...
export function discoverPromptXPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".promptx", "extensions")];
