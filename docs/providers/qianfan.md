---
summary: "Use Qianfan's unified API to access many models in PromptX"
read_when:
...
3. PromptX installed on your system
...
4. Copy the API key for use with PromptX

## CLI setup

```bash
promptx onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [PromptX Configuration](/gateway/configuration)
