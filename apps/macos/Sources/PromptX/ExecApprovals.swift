...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.promptx", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        PromptXPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PromptXPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
