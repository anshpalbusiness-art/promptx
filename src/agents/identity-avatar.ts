...
function resolveAvatarSource(cfg: PromptXConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PromptXConfig, agentId: string): AgentAvatarResolution {
