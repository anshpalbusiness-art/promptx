...
export type { PromptXConfig } from "../config/config.js";
/** @deprecated Use PromptXConfig instead */
export type { PromptXConfig as ClawdbotConfig } from "../config/config.js";
