import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "promptx/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "promptx/plugin-sdk";
